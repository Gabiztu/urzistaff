  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{__html: `
        ...
        label.chip { position: relative; display: inline-flex; align-items: center; cursor: pointer; padding: 6px 12px; border: 1px solid var(--border); border-radius: var(--pill); height: 32px; color: var(--text); background: var(--elev); font-weight: 500; font-size: 13px; }
        ...
        .filter-select { padding: 6px 12px; border-radius: 10px; border: 1px solid var(--border); background: var(--elev); color: var(--text); height: 32px; font-size: 13px; }
